				...
				<div class="row">
					...
					<div class="col-md-6 text-lg-right">
						<form class="community-filter">
							<label for="fdf5">exposição</label>
							<select id="fdf5">
				...
				<ul class="community-post-list">
					<li>
						<div class="community-post">
							...
							<div class="post-content">
								<h5>Marcos Vinicius<span>postou uma atualização</span></h5>
								<div class="post-date">40 minutos atrás</div>
								<p> </p>
							</div>
						</div>
					</li>
					<li>
						<div class="community-post">
							...
							<div class="post-content">
								<h5>Partik Williams<span>postou uma atualização</span></h5>
					...
					<li>
						<div class="community-post">
							...
							<div class="post-content">
								<h5>Ântoni Micael<span>postou uma atualização</span></h5>
					...
					<li>
						<div class="community-post">
							...
							<div class="post-content">
								<h5>Carlos Eduardo <span>postou uma atualização</span></h5>
					...
					<li>
						<div class="community-post">
							...
							<div class="post-content">
								<h5>Maria Clara<span>postou uma atualização</span></h5>
								<div class="post-date"> 2018</div>
								<p> </p>
							</div>
						</div>
					...
					<li>
						<div class="community-post">
							<div class="author-avator set-bg" data-setbg="img/authors/facebook.marcos.jpg"></div>
							<div class="post-content">
								<h5>Marcos Vinícius<span>postou uma atualização</span></h5>
								<div class="post-date">2018</div>
								<p> </p>
							</div>
						</div>
